...
//           onChange={onChange}
//           value={value}
//           className={`placeholder-placeHolder pr-10 focus:outline-none ${inputStyle} ${
//             leadingImage ? "pl-1" : ""
...
//     (withTogglePassword && type === "password") || type === "confirm_password";
...
//           value={value}
//           className={`placeholder-placeHolder   w-full focus:outline-none ${inputStyle} ${
//             leadingImage ? "pl-1 pr-1 " : "pr-10 bg-blue-600"
//           }`}
//           placeholder={placeholder}
//           disabled={disabled}
//           maxLength={maxLength}
